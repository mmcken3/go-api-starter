...
// TestGetEndpoint will return the welcome message for test in JSON as an example.
func TestGetEndpoint(w http.ResponseWriter, r *http.Request) {
...
// TestPostEndpoint will return the welcome message for test in JSON as an example.
...
*/
func TestPostEndpoint(w http.ResponseWriter, r *http.Request) {
